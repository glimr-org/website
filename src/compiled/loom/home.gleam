    ...
    slot: {
      ...
      <> components_container.render(
        slot: {
          ...
          <> "\n        <span class=\"text-[17px] font-semibold text-[#2B2E49]\">Glimr</span>\n      </a>\n      <div\n        class=\"flex items-center gap-6 text-[14.5px] font-medium text-[#2C2E49] nav\"\n      >\n        <a\n          href=\"https://github.com/glimr-org/glimr?tab=readme-ov-file#glimr-\"\n          target=\"_blank\"\n          class=\"hover:text-mist-700 transition-colors\"\n        >\n          Docs\n        </a>\n        <a\n          href=\"https://github.com/glimr-org/glimr\"\n          target=\"_blank\"\n          class=\"hover:text-mist-700 transition-colors\"\n        >\n          Github\n        </a>\n        <a\n          href=\"https://hex.pm/packages/glimr\"\n          target=\"_blank\"\n          class=\"hover:text-mist-700 transition-colors\"\n        >\n          Hex\n        </a>\n      </div>\n    "
        },
        attributes: [
          runtime.Attribute(
            "class",
      ...
      <> components_container.render(
        ...
        attributes: [
          runtime.Attribute("class", "pt-[60px] pb-[30px] flex items-start"),
        ],
      )
      <> "\n  </section>\n\n  <!-- Code Showcase -->\n  <section>\n    "
      <> components_container.render(
      ...
      <> components_container.render(
        ...
        attributes: [runtime.Attribute("class", "pt-[80px] pb-[100px]")],
      )
      <> "\n  </section>\n\n  "
      <> components_container.render(
        slot: {
        ...
        attributes: [runtime.Attribute("class", "py-[30px]")],
      )
      <> "\n"
    },
    attributes: [],
