    ...
    slot: {
      ...
      <> components_container.render(
        ...
        attributes: [
          runtime.Attribute(
            "class",
            "py-4 flex flex-col gap-3 text-[15px] font-medium text-[#2C2E49]",
          ),
        ],
      )
